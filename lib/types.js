 ...
 *
 * @typedef {(tag: XMLTag) => boolean} XMLTagFilter
 *
 * @typedef XMLTag
 ...
 * @property {Array<string>} inventories
 * @property {Array<string>} pricebooks
 *
 * @typedef CatalogReducerConfig
 * @property {string} outPostfix
 * @property {'createNew' | 'updateExisting'} behaviour
