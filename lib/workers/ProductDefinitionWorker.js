...
import CategorizedProductsContainer from '#model/CategorizedProductsContainer.js';
...
export default class ProductDefinitionWorker {
    ...
    async filterProductsByCategories(
        ...
        const result = {
            ...
            categorized: savedCategorizedProducts.getAllProductIDsByCategories(),
            allCategorized: savedCategorizedProducts.getAllProductIDs(),
            dependent: [
                ...savedDefaultProducts.getDependentProducts(),
                ...savedCategorizedProducts.getDependentProducts()
            ]
        };

        result.nonMasters = [
            ...result.dependent,
            ...savedCategorizedProducts.getStandardProducts(),
            ...savedDefaultProducts.standard
        ]
