...
/**
 * @template {Types.CatalogRegistry} RegistryConstructor
 */
module.exports = class CatalogWorker extends XMLMatcher {
    /**
     * @param {string} filePath
     * @param {RegistryConstructor} CatalogRegistryCtr
     */
    constructor (filePath, CatalogRegistryCtr) {
        super(filePath);
         ...
         */
        this.registry = new CatalogRegistryCtr(this.folder);
