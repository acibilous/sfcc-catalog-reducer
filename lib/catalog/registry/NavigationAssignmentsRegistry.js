...
/**
 * @typedef Cache
 * @property {Record<string, Types.Category>} categories
 * @property {Record<string, Types.Category>} finalCategoryAssignment
 * @property {Record<string, Types.Product>} finalProductList
 */

/**
 * @extends {ProductsRegistry<Cache>}
 */
module.exports = class NavigationAssignmentsRegistry extends ProductsRegistry {
    /**
