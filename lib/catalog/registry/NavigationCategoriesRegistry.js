...
export default class NavigationCategoriesRegistry extends Registry {
     ...
     */
     constructor (dataFolder, name) {
        super(dataFolder, ['categoriesParents'], name);
    }

    get cachePrefix () {
        return super.cachePrefix + '_categories_';
    }
     ...
     */
    addCategory (categoryId, parentId) {
        this.cache.categoriesParents[categoryId] = parentId;
    }
     ...
     */
    appendCategoriesParents(categoryCacheArray) {
