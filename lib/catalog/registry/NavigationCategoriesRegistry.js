...
export default class NavigationAssignmentsRegistry extends Registry {
    ...
    /**
     * @param {Array<Cache['categoriesParents']>} categoryRegistryArray
     */
    appendCategoriesParrents(categoryRegistryArray) {
        categoryRegistryArray.forEach(categoryRegistry => {
            Object.assign(this.cache.categoriesParents, categoryRegistry);
        });
    }
};
