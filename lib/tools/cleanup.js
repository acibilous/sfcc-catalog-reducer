 ...
 * @property {string} minifiedNavigationPath
 */
...
const getCleaner = ({
    ...
    return () => {
        ...
        removeFilesExcept(masterFolder, [masterPath, navigationPath, minifiedMasterPath, minifiedNavigationPath]);
        removeFilesExcept(navigationFolder, [masterPath, navigationPath, minifiedMasterPath, minifiedNavigationPath]);
    };
};
