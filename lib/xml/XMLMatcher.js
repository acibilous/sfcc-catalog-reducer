...
export default class XMLMatcher extends XMLParser {
    ...
    /**
     * @abstract
     * @param {string} _headerPart - before first matched tag in document
     */
    processHeaderPart (_headerPart) {}


    /**
     * @abstract
     * @param {string} _footerPart - after last matched tag in document
     */
    processFooterPart (_footerPart) {}
}
