...
export default class DependencyMap {
    ...
    /**
     * @param {import('#types').XMLProductDefinition | DependencyParent} parrentWithDependencies
     */
    addByParent(parrentWithDependencies) {
        const parent = parrentWithDependencies instanceof DependencyParent
            ? parrentWithDependencies
            : new DependencyParent(parrentWithDependencies);
