...
export default class CategorizedProductsContainer {
    ...
    getAllProductIDsByCategories() {
        return Object.keys(this.configs).reduce((accumulator, categoryID) => {
            accumulator[categoryID] = this.categories[categoryID].getAllProductIDs()
    ...
    getDependentProducts() {
        return Object.keys(this.configs).reduce((accumulator, categoryID) => [
            ...accumulator,
            ...this.categories[categoryID].getDependentProducts()
        ], /** @type {Array<string>} */([]));
    }
    ...
    getStandardProducts() {
        return Object.keys(this.configs).reduce((accumulator, categoryID) => [
            ...accumulator,
            ...this.categories[categoryID].standard
        ], /** @type {Array<string>} */([]));
    }
